...
_LAYERPARAMETER = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='cconv_depthwise_param', full_name='caffe.LayerParameter.cconv_depthwise_param', index=60,
...
_CCONVOLUTIONDEPTHWISEPARAMETER = _descriptor.Descriptor(
  name='CConvolutionDepthwiseParameter',
  full_name='caffe.CConvolutionDepthwiseParameter',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='is_pruning', full_name='caffe.CConvolutionDepthwiseParameter.is_pruning', index=0,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='iter_stop', full_name='caffe.CConvolutionDepthwiseParameter.iter_stop', index=1,
      number=3, type=2, cpp_type=6, label=1,
      has_default_value=True, default_value=float(15000),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      options=None),
    _descriptor.FieldDescriptor(
      name='inter_iter', full_name='caffe.CConvolutionDepthwiseParameter.inter_iter', index=2,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='weight_mask_filler', full_name='caffe.CConvolutionDepthwiseParameter.weight_mask_filler', index=3,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='bias_mask_filler', full_name='caffe.CConvolutionDepthwiseParameter.bias_mask_filler', index=4,
      number=6, type=11, cpp_type=10, label=1,
      has_default_value=False, default_value=None,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      options=None),
    _descriptor.FieldDescriptor(
      name='upper_bound', full_name='caffe.CConvolutionDepthwiseParameter.upper_bound', index=5,
...
_CINNERPRODUCTPARAMETER = _descriptor.Descriptor(
  ...
  fields=[
    _descriptor.FieldDescriptor(
      name='is_pruning', full_name='caffe.CInnerProductParameter.is_pruning', index=0,
      number=9, type=8, cpp_type=7, label=1,
      has_default_value=True, default_value=True,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      options=None),
    _descriptor.FieldDescriptor(
      name='iter_stop', full_name='caffe.CInnerProductParameter.iter_stop', index=1,
      number=3, type=2, cpp_type=6, label=1,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='inter_iter', full_name='caffe.CInnerProductParameter.inter_iter', index=2,
      number=7, type=2, cpp_type=6, label=1,
      has_default_value=True, default_value=float(1000),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      options=None),
    _descriptor.FieldDescriptor(
      name='weight_mask_filler', full_name='caffe.CInnerProductParameter.weight_mask_filler', index=3,
      number=5, type=11, cpp_type=10, label=1,
      has_default_value=False, default_value=None,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      options=None),
    _descriptor.FieldDescriptor(
      name='bias_mask_filler', full_name='caffe.CInnerProductParameter.bias_mask_filler', index=4,
      number=6, type=11, cpp_type=10, label=1,
      has_default_value=False, default_value=None,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      options=None),
    _descriptor.FieldDescriptor(
      name='upper_bound', full_name='caffe.CInnerProductParameter.upper_bound', index=5,
      number=8, type=2, cpp_type=6, label=1,
...
_CCONVOLUTIONPARAMETER = _descriptor.Descriptor(
  ...
  fields=[
    _descriptor.FieldDescriptor(
      name='iter_stop', full_name='caffe.CConvolutionParameter.iter_stop', index=0,
      number=3, type=2, cpp_type=6, label=1,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='inter_iter', full_name='caffe.CConvolutionParameter.inter_iter', index=1,
      number=7, type=2, cpp_type=6, label=1,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='weight_mask_filler', full_name='caffe.CConvolutionParameter.weight_mask_filler', index=2,
      number=5, type=11, cpp_type=10, label=1,
      has_default_value=False, default_value=None,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      options=None),
    _descriptor.FieldDescriptor(
      name='bias_mask_filler', full_name='caffe.CConvolutionParameter.bias_mask_filler', index=3,
      number=6, type=11, cpp_type=10, label=1,
      has_default_value=False, default_value=None,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      options=None),
    _descriptor.FieldDescriptor(
      name='upper_bound', full_name='caffe.CConvolutionParameter.upper_bound', index=4,
      number=8, type=2, cpp_type=6, label=1,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='is_pruning', full_name='caffe.CConvolutionParameter.is_pruning', index=5,
      number=9, type=8, cpp_type=7, label=1,
      has_default_value=True, default_value=True,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
...
_LAYERPARAMETER.fields_by_name['cconv_depthwise_param'].message_type = _CCONVOLUTIONDEPTHWISEPARAMETER
_CCONVOLUTIONDEPTHWISEPARAMETER.fields_by_name['weight_mask_filler'].message_type = _FILLERPARAMETER
_CCONVOLUTIONDEPTHWISEPARAMETER.fields_by_name['bias_mask_filler'].message_type = _FILLERPARAMETER
...
DESCRIPTOR.message_types_by_name['CConvolutionDepthwiseParameter'] = _CCONVOLUTIONDEPTHWISEPARAMETER
...
CConvolutionDepthwiseParameter = _reflection.GeneratedProtocolMessageType('CConvolutionDepthwiseParameter', (_message.Message,), dict(
  DESCRIPTOR = _CCONVOLUTIONDEPTHWISEPARAMETER,
  __module__ = 'caffe_pb2'
  # @@protoc_insertion_point(class_scope:caffe.CConvolutionDepthwiseParameter)
  ))
_sym_db.RegisterMessage(CConvolutionDepthwiseParameter)
